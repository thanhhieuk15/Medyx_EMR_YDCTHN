  ...
  <div>
    ...
    <el-form>
      <v-row :gutters="20">
        ...
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Tổng số lần phẫu thuật">
            <el-input v-model="tongSoLanPt" type="number" min="0" size="small" :disabled="true"></el-input>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Tổng số ngày điều trị sau phẫu thuật">
            <el-input v-model="tongSoNgayDtSauPt" type="number" min="0" size="small" :disabled="true"></el-input>
          </el-form-item>
        </v-col>
      </v-row>
    </el-form>
