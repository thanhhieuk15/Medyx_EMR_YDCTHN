        ...
        <el-form :model="form" :rules="rules" ref="form">
            <v-row>
                ...
                <v-col cols="6" class="padding-cols">
                    <el-form-item>
                        <br />
                        <el-checkbox @change="setModelFormCheckbox(tienSuBenhAn)" v-for="(item, index) in tienSuBenhAn"
                ...
                <v-col cols="12" class="padding-cols">
                    <el-form-item label="3. Dịch tễ">
                        <el-input v-model="form.donDaTriLieuHa" type="textarea" rows="2"></el-input>
                    </el-form-item>
                </v-col>
                <v-col cols="12" class="padding-cols">
                    <el-form-item label="Bệnh cấp tính đang lưu hành ở:">
                        <el-input v-model="form.dieuTriTangHathuongXuyen" type="textarea" rows="2"></el-input>
                    </el-form-item>
                </v-col>
                <v-col cols="12" class="padding-cols">
                    <el-form-item label="Đã sống ở nơi nào trước hoặc trong khi bị bệnh:">
                        <el-input v-model="form.noiDieuTriTangHa" type="textarea" rows="2"></el-input>
                    </el-form-item>
                </v-col>
                <v-col cols="12" class="padding-cols">
                    <el-form-item label="Thời gian">
                        <el-input v-model="form.thoiDiemPhatHienTangHa" type="text"></el-input>
                    </el-form-item>
                </v-col>
                <v-col cols="12" class="padding-cols">
                    <el-form-item label="Môi sinh (bệnh của người và gia súc đang lưu hành tại địa phương)">
                        <el-input v-model="form.thoiDiemPhatHienDtd" type="textarea" rows="2"></el-input>
                    </el-form-item>
                </v-col>
