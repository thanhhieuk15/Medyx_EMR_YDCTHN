      ...
      <v-row>
        ...
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Vào ngày thứ của bệnh">
            <el-input v-model="form.vaoNgayThu" dense outlined type="number" :min="0" size="small"></el-input>
          </el-form-item>
        </v-col>
        <v-col cols="12" class="padding-cols">
          ...
          <el-form-item>
            <div>
              ...
              <div style="font-style:italic; line-height: 8px;" class="pb-4">
                (Ý thức, da niêm mạc, hệ thống hạch,...)
              </div>
            </div>
        ...
        <v-col cols="12" class="padding-cols">
          <el-form-item label="2. Triệu chứng cơ năng">
            <el-input v-model="form.spO2" type="textarea"></el-input>
          </el-form-item>
        </v-col>
        <v-col cols="12" class="padding-cols">
          <el-form-item
            label="3.Thương tổn căn bản: (sơ phát, thứ phát, tính chất, loại phân bố, kích thước, hình dáng, mầu sắc vv	)">
        ...
        <v-col cols="12" class="padding-cols mt-4">
          <el-form-item label="4.Các cơ quan:"></el-form-item>
        </v-col>
        <v-col cols="12" class="padding-cols">
        ...
        <v-col cols="6" class="padding-cols">
          <el-form-item label="Ngày ký">
            <el-date-picker v-model="form.ngayKham" type="datetime" size="small" placeholder="dd/mm/yyyy hh:mm"
              style="width: 100%" format="dd/MM/yyyy HH:mm" value-format="yyyy-MM-ddTHH:mm:ss"></el-date-picker>
          </el-form-item>
        </v-col>
        <v-col cols="6" class="padding-cols">
          <el-form-item label="Bác sỹ làm bệnh án">
            <el-input v-model="form.bSKham" type="textarea"></el-input>
          </el-form-item>
        </v-col>
      </v-row>
    </el-form>
