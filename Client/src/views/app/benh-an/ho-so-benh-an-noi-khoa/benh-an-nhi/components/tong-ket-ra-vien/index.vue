          ...
          <div style="border: 1px solid #d6dbdf" class="pa-4 pb-8">
            <v-row>
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv2" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm theo 3</b>
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv3" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm theo 4</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv4" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv4" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm theo 5</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv5" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" clearable placeholder="" style="width: 100%"
                    size="small" @get-item="getTenBenhKem5Vv" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv5" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm theo 6</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv6" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" clearable placeholder="" style="width: 100%"
                    size="small" @get-item="getTenBenhKem6Vv" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv6" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm theo 7</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv7" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" clearable placeholder="" style="width: 100%"
                    size="small" @get-item="getTenBenhKem7Vv" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv7" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm theo 8</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv8" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" clearable placeholder="" style="width: 100%"
                    size="small" @get-item="getTenBenhKem8Vv" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv8" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm theo 9</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv9" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" clearable placeholder="" style="width: 100%"
          ...
          <div style="border: 1px solid #d6dbdf" class="pa-4 pb-8">
            <v-row>
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhChinhVvyhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 1</b>
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv2yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 3</b>
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv3yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 4</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv4yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv4yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 5</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv5yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv5yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 6</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv6yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv6yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 7</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv7yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv7yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 8</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv8yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemVv8yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 9</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemVv9yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
          ...
          <div style="border: 1px solid #d6dbdf" class="pa-4 pb-8">
            <v-row>
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv2" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 3 </b>
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv3" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 4 </b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv4" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv4" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv4" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 5 </b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv5" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv5" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv5" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 6 </b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv6" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv6" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv6" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 7 </b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv7" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv7" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv7" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 8 </b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv8" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv8" @change="onChangeBenhKem">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv8" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 9 </b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv9" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
          ...
          <div style="border: 1px solid #d6dbdf" class="pa-4 pb-8">
            <v-row>
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhChinhRvyhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b> Bệnh kèm 1</b>
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv2yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 3</b>
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv3yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 4</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv4yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv4yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 5</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv5yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv5yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 6</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv6yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv6yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 7</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv7yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv7yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 8</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv8yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
                ...
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form2.tenBenhKemRv8yhct" size="small" placeholder="Tên bệnh"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Bệnh kèm 9</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form2.maBenhKemRv9yhct"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh} - ${item.tenBenhBhyt}`" keyValue="maBenh"
                    :apiFunc="getChanDoanBenhCT" placeholder="" style="width: 100%" clearable size="small"
