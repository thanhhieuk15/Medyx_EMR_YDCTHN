    ...
    <div class="mt-3">
      <v-row :gutters="20">
        ...
        <v-col xl="3" lg="3" md="5" sm="6" class="d-flex align-end padding-cols">
          ...
          <el-radio-group row hide-details v-model="form.gioiTinh" style="padding-bottom: 6px">
        ...
        <v-col xl="6" lg="6" md="7" sm="12" class="d-flex align-end padding-cols">
          ...
          <el-radio-group row hide-details v-model="form.doiTuong.maDt" style="padding-bottom: 6px"
