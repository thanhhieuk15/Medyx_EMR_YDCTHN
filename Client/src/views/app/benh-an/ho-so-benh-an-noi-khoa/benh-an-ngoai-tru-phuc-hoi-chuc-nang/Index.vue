...
import { chiTietToBenhAn } from "@/api/benh-an.js";
...
export default {
  ...
  methods: {
    ...
    async getBenhAn(benhAnTienSuBenh, benhAnYhhd, benhAnYhct, benhAn) {
      let data = await chiTietToBenhAn(this.idba);
      this.form.benhAn = data.data;
      this.form.benhAnKhamYhct = benhAnYhct;
      this.form.benhAnKhamYhhd = benhAnYhhd;
      this.form.benhAnTienSuBenh = benhAnTienSuBenh;
      this.form.benhAn.maBenhChinhVv = benhAn.maBenhChinhVv;
      this.form.benhAn.tenBenhChinhVv = benhAn.tenBenhChinhVv;
    },
