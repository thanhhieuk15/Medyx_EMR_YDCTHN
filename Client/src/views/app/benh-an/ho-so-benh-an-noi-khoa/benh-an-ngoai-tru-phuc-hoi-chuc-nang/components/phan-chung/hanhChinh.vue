    ...
    <div class="mt-3">
      <v-row :gutters="20">
        ...
        <v-col
          ...
          class="d-flex align-end padding-cols"
        >
          <div class="mr-2 pt-4 title-lable">Đến khám bệnh lúc:</div>
          <div class="content-pchung">  {{
                        new Date(ngayVaoVienvv).toLocaleString("en-GB") 
                    }}</div>
        </v-col>
        <v-col
          xl="9"
          ...
          class="d-flex align-end padding-cols"
        >
          <div class="mr-2 pt-4 title-lable">Chẩn đoán và xử lý của nơi giới thiệu:</div>
          <div class="content-pchung">{{ ChuanDoanNoiGT }}</div>
        </v-col>
        <v-col
        xl="9"
          lg="9"
          ...
          class="d-flex align-end padding-cols"
        >
          <div class="mr-2 title-lable">*Giấy chứng nhận khuyết tật:</div>
          <el-radio-group
            row
            hide-details
            v-model="form.giayCNKhuyetTat"
            style="padding-bottom: 6px"
          >
        ...
        <v-col
          ...
          class="d-flex align-end padding-cols"
        >
          <div class="mr-2 pt-4 title-lable">Dạng khuyết tật:</div>
          <div class="content-pchung">{{ form.dangKhuyetTat }}</div>
        </v-col>
        <v-col
          xl="9"
          lg="9"
          ...
          class="d-flex align-end padding-cols"
        >
          <div class="mr-2 pt-4 title-lable">Mức độ khuyết tật:</div>
          <div class="content-pchung">{{ form.mucDoKhuyetTat }}</div>
        </v-col>
      </v-row>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async getThongTinChung() {
      ...
      this.ngayVaoVienvv = res.data.ngayVv;
      this.ChuanDoanNoiGT = res.data.tenBenhKemVv1;
