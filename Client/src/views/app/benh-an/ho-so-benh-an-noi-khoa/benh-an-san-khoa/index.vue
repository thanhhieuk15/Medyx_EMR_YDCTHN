...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        benhAnTienSuSan:null,
        benhAnPhuSan:null,
        benhAnTienSuBenh:null,
  ...
  methods: {
    ...
    getBenhAn(benhAnTienSuBenh, benhAnTienSuSan, benhAnPhuSan,benhAnPhauThuatPhieuPttt) {
      this.form.benhAnTienSuSan = benhAnTienSuSan;
      this.form.benhAnPhuSan = benhAnPhuSan;
