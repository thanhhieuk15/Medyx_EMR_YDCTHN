      ...
      <div class="menu-top ">
        <div class="d-flex justify-space-around align-center" style="
          ...
          <div class="d-flex">
            ...
            <!-- <v-btn color="primary" @click="handleSign1Fake" class="mr-4" small de depressed
              :disabled="!disableActions.export">
...
export default {
  ...
  methods: {
    async onPreviewFile() {
      try {
        ...
        if (response == undefined) {
          ...
          window.open(
            `${window.origin}/api/benh-an/xuat-file-Da-Ky/${this.idba}`,
            "_blank"
          );
        }
    ...
    async onDownloadFile() {
      try {
        const response = await DownloadFile(this.idba);
        ...
        let fileName = 'HSBA_' + this.id + formattedDate;
    ...
    getThongTinBenhAn(benhAn, benhAnkdt, thongtinbenhnhan) {
