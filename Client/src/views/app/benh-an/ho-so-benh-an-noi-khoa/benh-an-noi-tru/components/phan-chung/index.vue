  ...
  <div>
    ...
    <div>
      ...
      <div style="margin-top: 50px">
        <QuanLyNguoiBenh :benhAn="benhAn" :benhAnKhoaDieuTri="benhAnKhoaDieuTri"
          @get-quanLyNguoibenh="getQuanLyNguoibenh" />
      </div>
      <div style="margin-top: 50px">
        <ChanDoan :benhAn="benhAn" :benhAnKhoaDieuTri="benhAnKhoaDieuTri[0]" @get-chanDoan="getChanDoan" />
      </div>
      <div style="margin-top: 50px">
...
export default {
  ...
  methods: {
    ...
    getChanDoan(data) {
      ...
      // this.benhAn.TenBenhKemVv1 = data.benhKem1.tenBenh;
