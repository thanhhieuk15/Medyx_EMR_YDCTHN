  ...
  <div>
    ...
    <el-form :model="form" :rules="rules" ref="form">
      <v-row>
          ...
          <v-row>
            ...
            <v-col cols="3" class="padding-cols">
              <el-form-item label="Chiều cao (cm):">
                <el-input type="number" v-model="form.chieuCao" size="mini" :step="0.01" controls-position="right"
                  style="width: 100%"></el-input>
              </el-form-item>
            </v-col>
            <v-col cols="3" class="padding-cols">
        ...
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo (nếu có):">
            <base-select-async v-model="form.benhKem1.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
        ...
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 2(nếu có):">
            <base-select-async v-model="form.benhKem2.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 3(nếu có):">
            <base-select-async v-model="form.benhKem3.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 4(nếu có):">
            <base-select-async v-model="form.MaBenhKemVv4.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 5(nếu có):">
            <base-select-async v-model="form.benhKem5.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 6(nếu có):">
            <base-select-async v-model="form.benhKem6.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 7(nếu có):">
            <base-select-async v-model="form.benhKem7.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 8(nếu có):">
            <base-select-async v-model="form.benhKem8.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col>
        <v-col cols="4" class="padding-cols">
          <el-form-item label="Bệnh kèm theo 9(nếu có):">
            <base-select-async v-model="form.benhKem9.maBenh" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
              keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" size="small">
            </base-select-async>
          </el-form-item>
        </v-col> -->
