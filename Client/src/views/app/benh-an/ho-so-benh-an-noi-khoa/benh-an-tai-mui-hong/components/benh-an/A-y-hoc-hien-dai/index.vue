  ...
  <div>
    <el-form :model="form" :rules="rules" ref="form">
      <v-row>
        ...
        <v-col cols="12">
          <div>Hình vẽ mô tả tổn thương khi vào viện</div>
          <v-row>
            <v-col cols="3" class="padding-cols mt-4" style="display: flex;
    ...
    align-items: flex-start;">
        ...
        <v-col cols="12" class="padding-cols">
          <el-form-item label="Tâm thần, thần kinh:">
        ...
        <v-col cols="12" class="padding-cols">
          <el-form-item label="Da và mô dưới da:">
