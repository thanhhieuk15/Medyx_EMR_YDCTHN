...
function ProcessData(inputData) {
           ...
           // console.log("send length 0: " + inputData.length);
            ...
            console.log("send length 3: " + inputData);
...
var BkavCAPlugin = {
    ...
    */
    SignXML: function (objXml) {
       ...
       console.log(objXml.SigningTime);
        switch (objXml.SigningType) {
            ...
            case XML_SIGNING_TYPE.SIGN_XML_XPATH_FILTER:
                dataInput = FUNCTION_ID.SignXMLBase64XPathID + '*' + objXml.Base64String + '*' + objXml.tagSigning + '*' + objXml.nodeToSign + '*' + objXml.tagSaveResult + '*' + objXml.SigningTime + '*' + objXml.CertificateSerialNumber + '*' + dsSignature;
                break;
            case XML_SIGNING_TYPE.SIGN_XML_DATA_LIST:
                dataInput = FUNCTION_ID.SignXMLDataListID + '*' + objXml.Base64String + '*' + objXml.tagSigning + '*' + objXml.nodeToSign + '*' + objXml.tagSaveResult + '*' + objXml.SigningTime + '*' + objXml.CertificateSerialNumber + '*' + dsSignature;
                break;
            default:
                dataInput = FUNCTION_ID.SignXMLBase64ID + '*' + objXml.Base64String + '*' + objXml.tagSigning + '*' + objXml.nodeToSign + '*' + objXml.tagSaveResult + '*' + objXml.SigningTime + '*' + objXml.CertificateSerialNumber + '*' +dsSignature;
   ...
   // Open a dialog and choose files
    ...
    GetVersion: function (JSCallback) {
        var dataInput = "";
		
        dataInput = FUNCTION_ID.GetVersionID  +'*'+ BkavCAPluginCallback;
		objCallback.FunctionCallback = JSCallback;
        return ProcessData(dataInput)
    },
