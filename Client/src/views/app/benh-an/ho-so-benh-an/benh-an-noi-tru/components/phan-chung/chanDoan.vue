          ...
          <div style="border: 1px solid #d6dbdf" class="pa-4 pb-8">
            <v-row class="mt-0">
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem1.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem2.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    placeholder="" style="width: 100%" clearable size="small" @get-item="getTenBenhKem2Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem2.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Vào khoa điều trị - Bệnh kèm theo 3</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem3.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    clearable placeholder="" style="width: 100%" size="small" @get-item="getTenBenhKem3Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem3.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Vào khoa điều trị - Bệnh kèm theo 4</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem4.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    clearable placeholder="" style="width: 100%" size="small" @get-item="getTenBenhKem4Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem4.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Vào khoa điều trị - Bệnh kèm theo 5</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem5.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    clearable placeholder="" style="width: 100%" size="small" @get-item="getTenBenhKem5Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem5.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Vào khoa điều trị - Bệnh kèm theo 6</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem6.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    clearable placeholder="" style="width: 100%" size="small" @get-item="getTenBenhKem6Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem6.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Vào khoa điều trị - Bệnh kèm theo 7</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem7.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    clearable placeholder="" style="width: 100%" size="small" @get-item="getTenBenhKem7Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem7.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Vào khoa điều trị - Bệnh kèm theo 8</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem8.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    clearable placeholder="" style="width: 100%" size="small" @get-item="getTenBenhKem8Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem8.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              <v-col cols="12">
                <b>Vào khoa điều trị - Bệnh kèm theo 9</b>
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.benhKem9.maBenh"
                    :label="(item) => `${item.maBenh} - ${item.tenBenh}`" keyValue="maBenh" :apiFunc="getChanDoanBenh"
                    clearable placeholder="" style="width: 100%" size="small" @get-item="getTenBenhKem9Vv">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
                  <el-input v-model="form.benhKem9.tenBenh" size="small"></el-input>
                </el-form-item>
              </v-col>
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.maBenhKemRv3" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv3">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.maBenhKemRv4" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv4">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.maBenhKemRv5" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv5">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.maBenhKemRv6" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv6">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.maBenhKemRv7" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv7">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.maBenhKemRv8" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv8">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
              ...
              <v-col cols="12">
                ...
                <el-form-item label="Mã bệnh">
                  <base-select-async v-model="form.maBenhKemRv9" :label="(item) => `${item.maBenh} - ${item.tenBenh}`"
                    keyValue="maBenh" :apiFunc="getChanDoanBenh" placeholder="" style="width: 100%" clearable
                    size="small" @get-item="getTenBenhKemRv9">
                  </base-select-async>
                </el-form-item>
                <el-form-item label="Tên bệnh">
...
export default {
  ...
  methods: {
    ...
    getTenBenhKem4Vv(item) {
      if (item) {
        this.form.benhKem4.tenBenh = item.tenBenh;
      }
      else {
        this.form.benhKem4.tenBenh = null
      }
    },
    getTenBenhKem5Vv(item) {
      if (item) {
        this.form.benhKem5.tenBenh = item.tenBenh;
      }
      else {
        this.form.benhKem5.tenBenh = null
      }
    },
    getTenBenhKem6Vv(item) {
      if (item) {
        this.form.benhKem6.tenBenh = item.tenBenh;
      }
      else {
        this.form.benhKem6.tenBenh = null
      }
    },
    getTenBenhKem7Vv(item) {
      if (item) {
        this.form.benhKem7.tenBenh = item.tenBenh;
      }
      else {
        this.form.benhKem7.tenBenh = null
      }
    },
    getTenBenhKem8Vv(item) {
      if (item) {
        this.form.benhKem8.tenBenh = item.tenBenh;
      }
      else {
        this.form.benhKem8.tenBenh = null
      }
    },
    getTenBenhKem9Vv(item) {
      if (item) {
        this.form.benhKem9.tenBenh = item.tenBenh;
      }
      else {
        this.form.benhKem9.tenBenh = null
      }
    },
    ...
    getTenBenhKemRv4yhct(item) {
      if (item) {
        this.form.tenBenhKemRv4yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemRv5yhct(item) {
      if (item) {
        this.form.tenBenhKemRv5yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemRv6yhct(item) {
      if (item) {
        this.form.tenBenhKemRv6yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemRv7yhct(item) {
      if (item) {
        this.form.tenBenhKemRv7yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemRv8yhct(item) {
      if (item) {
        this.form.tenBenhKemRv8yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemRv9yhct(item) {
      if (item) {
        this.form.tenBenhKemRv9yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemVv4yhct(item) {
      if (item) {
        this.form.tenBenhKemVv4yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemVv5yhct(item) {
      if (item) {
        this.form.tenBenhKemVv5yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemVv6yhct(item) {
      if (item) {
        this.form.tenBenhKemVv6yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemVv7yhct(item) {
      if (item) {
        this.form.tenBenhKemVv7yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemVv8yhct(item) {
      if (item) {
        this.form.tenBenhKemVv8yhct = item.tenBenhBhyt;
      }
      else {
    ...
    getTenBenhKemVv9yhct(item) {
      if (item) {
        this.form.tenBenhKemVv9yhct = item.tenBenhBhyt;
      }
      else {
