...
namespace Medyx_EMR_BCA.Controllers.API.BenhAnKhoaDieuTris
{
	...
	[ApiController]
	// [SessionFilter]
	public class DmbaKqdtriController : ControllerBase
	{
		private IRepository<DmbaKqdtri> repository = null;
		public DmbaKqdtriController()
		{
			repository = new GenericRepository<DmbaKqdtri>();
		}
		...
		[SetCacheContextItem]
		public Response<DmbaKqdtri> Get([FromQuery] RequestParameters parameters)
		{
            ...
            return QueryParamsHelper.ResultDanhMucParams<DmbaKqdtri>(repository, query, parameters, "MaKqdt");
		}

		// GET api/<BenhAnKhoaDieuTriController>/5
		[HttpGet("{Ma}")]
		public DmbaKqdtri Detail(string Ma)
		{
