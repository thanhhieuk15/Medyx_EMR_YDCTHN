...
namespace Medyx_EMR_BCA.Controllers.API.BenhAnKhoaDieuTris
{
	...
	[ApiController]
	// [SessionFilter]
	public class DmdichVuChungloaiController : ControllerBase
	{
		private IRepository<DmdichVuChungloai> repository = null;
		public DmdichVuChungloaiController()
		{
			repository = new GenericRepository<DmdichVuChungloai>();
		}
		...
		[SetCacheContextItem]
		public Response<DmdichVuChungloai> Get([FromQuery] RequestParameters parameters)
		{
            ...
            return QueryParamsHelper.ResultDanhMucParams<DmdichVuChungloai>(repository, query, parameters, "MaChungLoai");

		}

		// GET api/<BenhAnKhoaDieuTriController>/5
		[HttpGet("{Ma}")]
		public DmdichVuChungloai Detail(string Ma)
		{
