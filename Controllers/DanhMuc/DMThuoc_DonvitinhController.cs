...
{
    public class DMThuoc_DonvitinhController : BCAController
    {
        #region Khởi tạo
        private IMemoryCache cache;
        //public readonly ISession session;
        public DMThuoc_DonvitinhController(IMemoryCache cache)
        {
            this.cache = cache;
        ...
        {
            //var response = _Thuoc_DonvitinhService.DMThuoc_DonvitinhGetListPaging(maDVT, tenDVT, maMay, ngaySD, nguoiSD, pageIndex, pageSize, add);
            ...
            if (string.IsNullOrEmpty(GhiChu))
                GhiChu = "";
            var response = db.DMThuoc_DonvitinhGetListPaging(maDVT, tenDVT, maMay, ngaySD, nguoiSD, pageIndex, pageSize, add, GhiChu);
            return CreateJsonJsonResult(() =>
            {
        ...
        [HttpPost]
        public ActionResult Modify(DMThuoc_Donvitinh Thuoc_Donvitinh)
        {
            var u = SessionHelper.GetObjectFromJson<UserProfileSessionData>(HttpContext.Session, "UserProfileSessionData");
            var Quyen = u.ListRoleSession.Where(x => x.ActionDetailsName == "/DMThuoc_Donvitinh/Index/Modify").Count() > 0;
            if (Quyen)
            {
                ...
                emp.TenBang = "DMThuoc_Donvitinh";
                emp.KieuTacDong = "Update";
                emp.NguoiSD = u.Pub_sNguoiSD;
                emp.MaMay = MaMay;
                emp.NoiDungSD = JsonConvert.SerializeObject(Thuoc_Donvitinh);
                collection.InsertOne(emp);
                #endregion
                db.spDMThuoc_Donvitinh_UPDATE(Thuoc_Donvitinh.MaDVT, Thuoc_Donvitinh.TenDVT, MaMay, u.Pub_sNguoiSD, Thuoc_Donvitinh.Huy, Thuoc_Donvitinh.GhiChu);
        ...
        [HttpPost]
        public ActionResult DeleteThuoc_Donvitinh(string maDVT)
        {
            var u = SessionHelper.GetObjectFromJson<UserProfileSessionData>(HttpContext.Session, "UserProfileSessionData");
            var Quyen = u.ListRoleSession.Where(x => x.ActionDetailsName == "/DMThuoc_Donvitinh/Index/Delete").Count() > 0;
            if (Quyen)
            {
                HL7CoreDataDataContext db = new HL7CoreDataDataContext();
                string MaMay = this.GetLocalIPAddress();
                ...
                collection.InsertOne(emp);
                #endregion
                db.spDMThuoc_Donvitinh_DELETED(maDVT, MaMay, u.Pub_sNguoiSD);
        ...
        [HttpPost]
        public ActionResult CreateThuoc_Donvitinh(string tenDVT, string GhiChu)
        {
            var u = SessionHelper.GetObjectFromJson<UserProfileSessionData>(HttpContext.Session, "UserProfileSessionData");
            var Quyen = u.ListRoleSession.Where(x => x.ActionDetailsName == "/DMThuoc_Donvitinh/Index/Create").Count() > 0;
            if (Quyen)
            {
                string MaMay = this.GetLocalIPAddress();
                HL7CoreDataDataContext db = new HL7CoreDataDataContext();
                ...
                collection.InsertOne(emp);
                #endregion
                db.spDMThuoc_Donvitinh_CREATE(tenDVT, MaMay, u.Pub_sNguoiSD,GhiChu);
        ...
        //public JsonResult DMThuoc_DonvitinhGetAll()
        //{
        //    var response = _Thuoc_DonvitinhService.DMThuoc_DonvitinhGetAll();
        //    return CreateJsonJsonResult(() =>
        //    {
        //        return Json(response, JsonRequestBehavior.AllowGet);
        //    });
        ...
        public ActionResult ExportExcel(string obj)
        {
            ...
            HL7CoreDataDataContext db = new HL7CoreDataDataContext();
            var dataSource = db.ExportDMThuoc_Donvitinh(key, columns);
            string filename = "DMThuoc_Donvitinh " + DateTime.Now.ToString() + ".xlsx";
            //MVC4 mVC4 = new MVC4();
            //mVC4.
        ...
        {
            var u = SessionHelper.GetObjectFromJson<UserProfileSessionData>(HttpContext.Session, "UserProfileSessionData");
            var Quyen = u.ListRoleSession.Where(x => x.ActionDetailsName == "/DMThuoc_Donvitinh/Index/ImportDanhMuc").Count() > 0;
            if (Quyen)
            {
                ...
                if (file != null && file.Length > 0)
                {
                    ...
                    reader.Close();
                    result.Tables[0].TableName = "DMThuoc_Donvitinh";
                    ...
                    collection.InsertOne(emp);
                    #endregion
                    db.ImportDMThuoc_Donvitinh(result.Tables[0], insert);
