...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        opening: function () {
            ...
            function _makeMaskCss() { // Width Div tổng
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "<div class='select2-drop select2-drop-multi select2-display-none'>",
                  "   <ul style='widh:10px' class='select2-header'>",
                "   </ul>",
                "   <ul  style='widh:10px' class='select2-results'>",
                "   </ul>",
                "</div>"].join(""));
            return container;
        },
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Nhập nhiều hơn " + n + " ký tự " + (n == 1 ? "" : ""); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Xóa  " + n + " ký tự" + (n == 1 ? "" : ""); },
        formatSelectionTooBig: function (limit) { return "You can only select " + limit + " item" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Đang tải dữ liệu vui lòng chờ chút...."; },
