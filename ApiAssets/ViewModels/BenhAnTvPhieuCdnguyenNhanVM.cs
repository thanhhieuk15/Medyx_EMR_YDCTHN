...
{
    public class BenhAnTvPhieuCdnguyenNhanVM
    {
        [Required(ErrorMessage = "Số phiếu là bắt buộc.")]
        public string SoPhieu { get; set; }
        [CompareWithNgayVv("Idba", ErrorMessage = "2.Ngày tử vong phải lớn hơn hoặc bằng ngày giờ vào viện {1}.")]
        [CompareWithNgayRv("Idba", ErrorMessage = "2.Ngày tử vong phải nhỏ hơn hoặc bằng ngày giờ ra viện {1}.")]
        ...
        [CompareWithNgayVv("Idba", ErrorMessage = "14.Ngày phẫu thuật phải lớn hơn hoặc bằng ngày giờ vào viện {1}.")]
        [CompareWithNgayRv("Idba", ErrorMessage = "14.Ngày phẫu thuật phải nhỏ hơn hoặc bằng ngày giờ ra viện {1}.")]
        ...
        public string MaBenhNntv { get; set; }
        public string TenNntv { get; set; }
        public string NguoiLapPhieu { get; set; }
        public string Thutruong { get; set; }
        [CompareWithNgayVv("Idba", ErrorMessage = "39.Ngày ký phải lớn hơn hoặc bằng ngày giờ vào viện {1}.")]
        [CompareWithNgayRv("Idba", ErrorMessage = "39.Ngày ký phải nhỏ hơn hoặc bằng ngày giờ ra viện {1}.")]
        public DateTime? NgayKy { get; set; }
        public bool? Huy { get; set; }
    }
    public class BenhAnTvPhieuCdnguyenNhanCreateVM : BenhAnTvPhieuCdnguyenNhanVM
    {
