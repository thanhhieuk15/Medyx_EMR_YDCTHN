...
{
    public partial class BenhAnTvPhieuCdnguyenNhan : ITrackableCreate, ITrackableUpdate, ITrackableTrangThaiHuy, ITrackableMaMay, ITrackableIDBA
    {
        ...
        [JsonIgnore]
        public virtual DmbenhTat DmbenhTat { get; set; }
        [JsonIgnore]
        public virtual DmnhanVien DmNguoiLapPhieu { get; set; }
        [JsonIgnore]
        public virtual DmnhanVien DmThutruong { get; set; }
    }
}
